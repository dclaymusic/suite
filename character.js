...
{
	let char;
	if(tileTypes[gameMap[toIndex(playerX(),playerY())]].player != undefined)
	{
		
		char = tileTypes[gameMap[toIndex(playerX(),playerY())]];
		ctx.drawImage(char.playerImg, player.position[0],player.position[1],tileW,tileH);
	}
	else
	{
		//if you want image to be visible
		// char = tileTypes[0];
		// ctx.drawImage(char.img, player.position[0],player.position[1],tileW,tileH);
	}
...
function Character()
{
	...
	this.sprites[directions.right] = [{x:tileW*0, y:tileH*3, w:tileW, h:tileH}];
	this.sprites[directions.left] = [{x:tileW*0, y:tileH*3, w:tileW, h:tileH}];
	this.sprites[directions.down] = [{x:tileW*0, y:tileH*3, w:tileW, h:tileH}];
